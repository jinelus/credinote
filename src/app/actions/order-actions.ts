...
import { PrismaOrderRepository } from "@/src/db/repositories/prisma-order-repository";
import { CreateOrderUseCase, CreateOrderUseCaseProps } from "@/src/domain/application/use-cases/create-order";
import { DeleteOrderUseCase } from "@/src/domain/application/use-cases/delete-order";
import { FetchOrdersByClientUseCase } from "@/src/domain/application/use-cases/fetch-orders-client";
import { GetOrderUseCase } from "@/src/domain/application/use-cases/get-order";
